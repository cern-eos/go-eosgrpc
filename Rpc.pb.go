...
func (NSRequest_VersionRequest_VERSION_CMD) EnumDescriptor() ([]byte, []int) {
	return file_Rpc_proto_rawDescGZIP(), []int{23, 7, 0}
}

type NSRequest_RecycleRequest_DisplayType int32

const (
	NSRequest_RecycleRequest_UID NSRequest_RecycleRequest_DisplayType = 0
	NSRequest_RecycleRequest_RID NSRequest_RecycleRequest_DisplayType = 1
	NSRequest_RecycleRequest_ALL NSRequest_RecycleRequest_DisplayType = 2
)

// Enum value maps for NSRequest_RecycleRequest_DisplayType.
var (
	NSRequest_RecycleRequest_DisplayType_name = map[int32]string{
		0: "UID",
		1: "RID",
		2: "ALL",
	}
	NSRequest_RecycleRequest_DisplayType_value = map[string]int32{
		"UID": 0,
		"RID": 1,
		"ALL": 2,
	}
...
func (x NSRequest_RecycleRequest_DisplayType) Enum() *NSRequest_RecycleRequest_DisplayType {
	p := new(NSRequest_RecycleRequest_DisplayType)
	*p = x
	return p
}

func (x NSRequest_RecycleRequest_DisplayType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (NSRequest_RecycleRequest_DisplayType) Descriptor() protoreflect.EnumDescriptor {
	return file_Rpc_proto_enumTypes[5].Descriptor()
}

func (NSRequest_RecycleRequest_DisplayType) Type() protoreflect.EnumType {
	return &file_Rpc_proto_enumTypes[5]
}

func (x NSRequest_RecycleRequest_DisplayType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use NSRequest_RecycleRequest_DisplayType.Descriptor instead.
func (NSRequest_RecycleRequest_DisplayType) EnumDescriptor() ([]byte, []int) {
	return file_Rpc_proto_rawDescGZIP(), []int{23, 8, 0}
}
...
func (NSRequest_RecycleRequest_RECYCLE_CMD) EnumDescriptor() ([]byte, []int) {
	return file_Rpc_proto_rawDescGZIP(), []int{23, 8, 1}
}
...
func (NSRequest_AclRequest_ACL_COMMAND) EnumDescriptor() ([]byte, []int) {
	return file_Rpc_proto_rawDescGZIP(), []int{23, 12, 0}
}
...
func (NSRequest_AclRequest_ACL_TYPE) EnumDescriptor() ([]byte, []int) {
	return file_Rpc_proto_rawDescGZIP(), []int{23, 12, 1}
}
...
func (NSRequest_ShareRequest_LsShare_OutFormat) EnumDescriptor() ([]byte, []int) {
	return file_Rpc_proto_rawDescGZIP(), []int{23, 15, 0, 0}
}
...
func (NSRequest_ShareRequest_OperateShare_Op) EnumDescriptor() ([]byte, []int) {
	return file_Rpc_proto_rawDescGZIP(), []int{23, 15, 1, 0}
}
...
func (NSResponse_RecycleResponse_RecycleInfo_DELETIONTYPE) EnumDescriptor() ([]byte, []int) {
	return file_Rpc_proto_rawDescGZIP(), []int{24, 2, 0, 0}
}
...
func (x *NotificationRequest) GetMessage() []byte {
	if x != nil {
		return x.Message
	}
	return nil
...
type FileMdProto struct {
	...
	Checksums       []*Checksum       `protobuf:"bytes,19,rep,name=checksums,proto3" json:"checksums,omitempty"`
}
...
func (x *FileMdProto) GetChecksums() []*Checksum {
	if x != nil {
		return x.Checksums
	}
	return nil
...
func (x *ContainerMdProto) GetFiles() uint64 {
	if x != nil {
		return x.Files
	}
	return 0
...
func (x *ContainerMdProto) GetContainers() uint64 {
	if x != nil {
		return x.Containers
	}
	return 0
...
type RoleId struct {
	...
	Onbehalf  string `protobuf:"bytes,7,opt,name=onbehalf,proto3" json:"onbehalf,omitempty"`
}
...
func (x *RoleId) GetOnbehalf() string {
	if x != nil {
		return x.Onbehalf
	}
	return ""
...
func (x *MDNotification) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MDNotification) ProtoMessage() {}

func (x *MDNotification) ProtoReflect() protoreflect.Message {
	mi := &file_Rpc_proto_msgTypes[18]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MDNotification.ProtoReflect.Descriptor instead.
func (*MDNotification) Descriptor() ([]byte, []int) {
	return file_Rpc_proto_rawDescGZIP(), []int{18}
}

func (x *MDNotification) GetType() TYPE {
	if x != nil {
		return x.Type
	}
	return TYPE_FILE
...
func (x *MDNotification) GetFmd() *FileMdProto {
	if x != nil {
		return x.Fmd
	}
	return nil
...
func (x *MDNotification) GetCmd() *ContainerMdProto {
	if x != nil {
		return x.Cmd
	}
	return nil
...
func (x *MDNotification) GetRole() *RoleId {
	if x != nil {
		return x.Role
	}
	return nil
...
// Deprecated: Marked as deprecated in Rpc.proto.
func (x *NSRequest) GetOldRecycle() *NSRequest_RecycleRequest {
	if x, ok := x.GetCommand().(*NSRequest_OldRecycle); ok {
		return x.OldRecycle
	}
	return nil
}
...
type NSRequest_OldRecycle struct {
	// Deprecated: use recycle = 37 (eos.console.RecycleProto) instead.
	// Supports only RESTORE, PURGE, LIST; missing config/project sub-commands.
	//
	// Deprecated: Marked as deprecated in Rpc.proto.
	OldRecycle *NSRequest_RecycleRequest `protobuf:"bytes,29,opt,name=old_recycle,json=oldRecycle,proto3,oneof"`
}
...
func (*NSRequest_OldRecycle) isNSRequest_Command() {}
...
func (*NSRequest_RmdirRequest) Descriptor() ([]byte, []int) {
	return file_Rpc_proto_rawDescGZIP(), []int{23, 1}
}
...
func (*NSRequest_TouchRequest) Descriptor() ([]byte, []int) {
	return file_Rpc_proto_rawDescGZIP(), []int{23, 2}
}
...
func (*NSRequest_UnlinkRequest) Descriptor() ([]byte, []int) {
	return file_Rpc_proto_rawDescGZIP(), []int{23, 3}
}
...
type NSRequest_RmRequest struct {
	...
	Recursive  bool  `protobuf:"varint,2,opt,name=recursive,proto3" json:"recursive,omitempty"`
	Norecycle  bool  `protobuf:"varint,3,opt,name=norecycle,proto3" json:"norecycle,omitempty"`
	Noglobbing bool  `protobuf:"varint,4,opt,name=noglobbing,proto3" json:"noglobbing,omitempty"`
}
...
func (*NSRequest_RmRequest) Descriptor() ([]byte, []int) {
	return file_Rpc_proto_rawDescGZIP(), []int{23, 4}
}
...
func (x *NSRequest_RmRequest) GetNoglobbing() bool {
	if x != nil {
		return x.Noglobbing
	}
	return false
...
func (*NSRequest_RenameRequest) Descriptor() ([]byte, []int) {
	return file_Rpc_proto_rawDescGZIP(), []int{23, 5}
}
...
func (*NSRequest_SymlinkRequest) Descriptor() ([]byte, []int) {
	return file_Rpc_proto_rawDescGZIP(), []int{23, 6}
}
...
func (*NSRequest_VersionRequest) Descriptor() ([]byte, []int) {
	return file_Rpc_proto_rawDescGZIP(), []int{23, 7}
}
...
type NSRequest_RecycleRequest struct {
	...
	RecycleId   string                                 `protobuf:"bytes,2,opt,name=recycleId,proto3" json:"recycleId,omitempty"`
	Cmd         NSRequest_RecycleRequest_RECYCLE_CMD   `protobuf:"varint,3,opt,name=cmd,proto3,enum=eos.rpc.NSRequest_RecycleRequest_RECYCLE_CMD" json:"cmd,omitempty"`
	Restoreflag *NSRequest_RecycleRequest_RestoreFlags `protobuf:"bytes,4,opt,name=restoreflag,proto3" json:"restoreflag,omitempty"`
	Purgedate   *NSRequest_RecycleRequest_PurgeDate    `protobuf:"bytes,5,opt,name=purgedate,proto3" json:"purgedate,omitempty"`
	Listflag    *NSRequest_RecycleRequest_ListFlags    `protobuf:"bytes,6,opt,name=listflag,proto3" json:"listflag,omitempty"`
}
...
func (*NSRequest_RecycleRequest) Descriptor() ([]byte, []int) {
	return file_Rpc_proto_rawDescGZIP(), []int{23, 8}
}
...
func (x *NSRequest_RecycleRequest) GetRecycleId() string {
	if x != nil {
		return x.RecycleId
	}
	return ""
...
func (x *NSRequest_RecycleRequest) GetListflag() *NSRequest_RecycleRequest_ListFlags {
	if x != nil {
		return x.Listflag
	}
	return nil
...
func (*NSRequest_SetXAttrRequest) Descriptor() ([]byte, []int) {
	return file_Rpc_proto_rawDescGZIP(), []int{23, 9}
}
...
func (*NSRequest_ChownRequest) Descriptor() ([]byte, []int) {
	return file_Rpc_proto_rawDescGZIP(), []int{23, 10}
}
...
func (*NSRequest_ChmodRequest) Descriptor() ([]byte, []int) {
	return file_Rpc_proto_rawDescGZIP(), []int{23, 11}
}
...
type NSRequest_AclRequest struct {
	...
	SyncWrite bool                             `protobuf:"varint,7,opt,name=sync_write,json=syncWrite,proto3" json:"sync_write,omitempty"`
}
...
func (*NSRequest_AclRequest) Descriptor() ([]byte, []int) {
	return file_Rpc_proto_rawDescGZIP(), []int{23, 12}
}
...
func (x *NSRequest_AclRequest) GetSyncWrite() bool {
	if x != nil {
		return x.SyncWrite
	}
	return false
...
func (*NSRequest_TokenRequest) Descriptor() ([]byte, []int) {
	return file_Rpc_proto_rawDescGZIP(), []int{23, 13}
}
...
func (*NSRequest_QuotaRequest) Descriptor() ([]byte, []int) {
	return file_Rpc_proto_rawDescGZIP(), []int{23, 14}
}
...
func (*NSRequest_ShareRequest) Descriptor() ([]byte, []int) {
	return file_Rpc_proto_rawDescGZIP(), []int{23, 15}
}
...
type NSRequest_RecycleRequest_ListFlags struct {
	...
	Display    NSRequest_RecycleRequest_DisplayType `protobuf:"varint,6,opt,name=display,proto3,enum=eos.rpc.NSRequest_RecycleRequest_DisplayType" json:"display,omitempty"`
	DisplayVal string                               `protobuf:"bytes,7,opt,name=display_val,json=displayVal,proto3" json:"display_val,omitempty"`
}

func (x *NSRequest_RecycleRequest_ListFlags) Reset() {
	*x = NSRequest_RecycleRequest_ListFlags{}
	if protoimpl.UnsafeEnabled {
...
func (x *NSRequest_RecycleRequest_ListFlags) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*NSRequest_RecycleRequest_ListFlags) ProtoMessage() {}

func (x *NSRequest_RecycleRequest_ListFlags) ProtoReflect() protoreflect.Message {
	mi := &file_Rpc_proto_msgTypes[48]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use NSRequest_RecycleRequest_ListFlags.ProtoReflect.Descriptor instead.
func (*NSRequest_RecycleRequest_ListFlags) Descriptor() ([]byte, []int) {
	return file_Rpc_proto_rawDescGZIP(), []int{23, 8, 2}
}

func (x *NSRequest_RecycleRequest_ListFlags) GetMaxentries() int32 {
	if x != nil {
		return x.Maxentries
	}
	return 0
...
func (x *NSRequest_RecycleRequest_ListFlags) GetYear() int32 {
	if x != nil {
		return x.Year
	}
	return 0
...
func (x *NSRequest_RecycleRequest_ListFlags) GetMonth() int32 {
	if x != nil {
		return x.Month
	}
	return 0
...
func (x *NSRequest_RecycleRequest_ListFlags) GetDay() int32 {
	if x != nil {
		return x.Day
	}
	return 0
...
func (x *NSRequest_RecycleRequest_ListFlags) GetIndex() int32 {
	if x != nil {
		return x.Index
	}
	return 0
...
func (x *NSRequest_RecycleRequest_ListFlags) GetDisplay() NSRequest_RecycleRequest_DisplayType {
	if x != nil {
		return x.Display
	}
	return NSRequest_RecycleRequest_UID
}

func (x *NSRequest_RecycleRequest_ListFlags) GetDisplayVal() string {
	if x != nil {
		return x.DisplayVal
	}
	return ""
...
func (*NSRequest_ShareRequest_LsShare) Descriptor() ([]byte, []int) {
	return file_Rpc_proto_rawDescGZIP(), []int{23, 15, 0}
}
...
func (*NSRequest_ShareRequest_OperateShare) Descriptor() ([]byte, []int) {
	return file_Rpc_proto_rawDescGZIP(), []int{23, 15, 1}
}
...
func (*NSResponse_RecycleResponse) Descriptor() ([]byte, []int) {
	return file_Rpc_proto_rawDescGZIP(), []int{24, 2}
}
...
func (*NSResponse_AclResponse) Descriptor() ([]byte, []int) {
	return file_Rpc_proto_rawDescGZIP(), []int{24, 3}
}
...
func (*NSResponse_QuotaResponse) Descriptor() ([]byte, []int) {
	return file_Rpc_proto_rawDescGZIP(), []int{24, 4}
}
...
func (*NSResponse_ShareInfo) Descriptor() ([]byte, []int) {
	return file_Rpc_proto_rawDescGZIP(), []int{24, 5}
}
...
func (*NSResponse_ShareAccess) Descriptor() ([]byte, []int) {
	return file_Rpc_proto_rawDescGZIP(), []int{24, 6}
}
...
func (*NSResponse_ShareResponse) Descriptor() ([]byte, []int) {
	return file_Rpc_proto_rawDescGZIP(), []int{24, 7}
}
...
func (*NSResponse_VersionResponse_VersionInfo) Descriptor() ([]byte, []int) {
	return file_Rpc_proto_rawDescGZIP(), []int{24, 1, 0}
}
...
func (*NSResponse_RecycleResponse_RecycleInfo) Descriptor() ([]byte, []int) {
	return file_Rpc_proto_rawDescGZIP(), []int{24, 2, 0}
}
...
var file_Rpc_proto_rawDesc = []byte{
	...
	0x2e, 0x72, 0x70, 0x63, 0x1a, 0x0d, 0x52, 0x65, 0x63, 0x79, 0x63, 0x6c, 0x65, 0x2e, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x1a, 0x14, 0x54, 0x72, 0x61, 0x66, 0x66, 0x69, 0x63, 0x53, 0x68, 0x61, 0x70,
	0x69, 0x6e, 0x67, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x41, 0x0a, 0x0b, 0x50, 0x69, 0x6e,
	0x67, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x18, 0x0a, 0x07, 0x61, 0x75, 0x74, 0x68,
	...
	0x01, 0x28, 0x0c, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x25, 0x0a, 0x09,
	...
	0x61, 0x67, 0x65, 0x22, 0x2f, 0x0a, 0x13, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74,
	...
	,
	...
	0x52, 0x03, 0x67, 0x69, 0x64, 0x12, 0x1b, 0x0a, 0x09, 0x74, 0x72, 0x65, 0x65, 0x5f, 0x73, 0x69,
	0x7a, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x03, 0x52, 0x08, 0x74, 0x72, 0x65, 0x65, 0x53, 0x69,
	0x7a, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x6d, 0x6f, 0x64, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0d,
	0x52, 0x04, 0x6d, 0x6f, 0x64, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x66, 0x6c, 0x61, 0x67, 0x73, 0x18,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x69, 0x64, 0x12, 0x23, 0x0a, 0x04, 0x72, 0x6f, 0x6c, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x0f, 0x2e, 0x65, 0x6f, 0x73, 0x2e, 0x72, 0x70, 0x63, 0x2e, 0x52, 0x6f, 0x6c, 0x65, 0x49,
	0x64, 0x52, 0x04, 0x72, 0x6f, 0x6c, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x61, 0x75, 0x74, 0x68, 0x6b,
	0x65, 0x79, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x61, 0x75, 0x74, 0x68, 0x6b, 0x65,
	0x79, 0x12, 0x1a, 0x0a, 0x08, 0x6d, 0x61, 0x78, 0x64, 0x65, 0x70, 0x74, 0x68, 0x18, 0x05, 0x20,
	0x01, 0x28, 0x04, 0x52, 0x08, 0x6d, 0x61, 0x78, 0x64, 0x65, 0x70, 0x74, 0x68, 0x12, 0x32, 0x0a,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x79, 0x63, 0x6c, 0x65, 0x12, 0x1e, 0x0a, 0x0a, 0x6e, 0x6f, 0x67, 0x6c, 0x6f, 0x62, 0x62, 0x69,
	0x6e, 0x67, 0x18, 0x04, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0a, 0x6e, 0x6f, 0x67, 0x6c, 0x6f, 0x62,
	0x62, 0x69, 0x6e, 0x67, 0x1a, 0x46, 0x0a, 0x0d, 0x52, 0x65, 0x6e, 0x61, 0x6d, 0x65, 0x52, 0x65,
	...
	0x61, 0x72, 0x67, 0x65, 0x74, 0x1a, 0xec, 0x01, 0x0a, 0x0e, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f,
	...
	,
	...
	0x79, 0x1a, 0xe7, 0x01, 0x0a, 0x09, 0x4c, 0x69, 0x73, 0x74, 0x46, 0x6c, 0x61, 0x67, 0x73, 0x12,
	0x1e, 0x0a, 0x0a, 0x6d, 0x61, 0x78, 0x65, 0x6e, 0x74, 0x72, 0x69, 0x65, 0x73, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x05, 0x52, 0x0a, 0x6d, 0x61, 0x78, 0x65, 0x6e, 0x74, 0x72, 0x69, 0x65, 0x73, 0x12,
	...
	0x18, 0x04, 0x20, 0x01, 0x28, 0x05, 0x52, 0x03, 0x64, 0x61, 0x79, 0x12, 0x14, 0x0a, 0x05, 0x69,
	0x6e, 0x64, 0x65, 0x78, 0x18, 0x05, 0x20, 0x01, 0x28, 0x05, 0x52, 0x05, 0x69, 0x6e, 0x64, 0x65,
	0x78, 0x12, 0x47, 0x0a, 0x07, 0x64, 0x69, 0x73, 0x70, 0x6c, 0x61, 0x79, 0x18, 0x06, 0x20, 0x01,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
...
var file_Rpc_proto_msgTypes = make([]protoimpl.MessageInfo, 62)
var file_Rpc_proto_goTypes = []interface{}{
	(TYPE)(0),       // 0: eos.rpc.TYPE
	(QUOTATYPE)(0),  // 1: eos.rpc.QUOTATYPE
	(QUOTAOP)(0),    // 2: eos.rpc.QUOTAOP
	(QUOTAENTRY)(0), // 3: eos.rpc.QUOTAENTRY
	(NSRequest_VersionRequest_VERSION_CMD)(0),                // 4: eos.rpc.NSRequest.VersionRequest.VERSION_CMD
	(NSRequest_RecycleRequest_DisplayType)(0),                // 5: eos.rpc.NSRequest.RecycleRequest.DisplayType
	...
	(*NotificationRequest)(nil),                              // 14: eos.rpc.NotificationRequest
	(*NotificationResponse)(nil),                             // 15: eos.rpc.NotificationResponse
	(*ContainerInsertRequest)(nil),                           // 16: eos.rpc.ContainerInsertRequest
	(*FileInsertRequest)(nil),                                // 17: eos.rpc.FileInsertRequest
	(*InsertReply)(nil),                                      // 18: eos.rpc.InsertReply
	(*Time)(nil),                                             // 19: eos.rpc.Time
	(*Checksum)(nil),                                         // 20: eos.rpc.Checksum
	(*FileMdProto)(nil),                                      // 21: eos.rpc.FileMdProto
	(*ContainerMdProto)(nil),                                 // 22: eos.rpc.ContainerMdProto
	(*QuotaProto)(nil),                                       // 23: eos.rpc.QuotaProto
	(*RoleId)(nil),                                           // 24: eos.rpc.RoleId
	(*MDId)(nil),                                             // 25: eos.rpc.MDId
	(*Limit)(nil),                                            // 26: eos.rpc.Limit
	(*MDSelection)(nil),                                      // 27: eos.rpc.MDSelection
	(*MDRequest)(nil),                                        // 28: eos.rpc.MDRequest
	(*MDResponse)(nil),                                       // 29: eos.rpc.MDResponse
	(*MDNotification)(nil),                                   // 30: eos.rpc.MDNotification
	(*FindRequest)(nil),                                      // 31: eos.rpc.FindRequest
	(*ShareAuth)(nil),                                        // 32: eos.rpc.ShareAuth
	(*ShareProto)(nil),                                       // 33: eos.rpc.ShareProto
	(*ShareToken)(nil),                                       // 34: eos.rpc.ShareToken
	(*NSRequest)(nil),                                        // 35: eos.rpc.NSRequest
	(*NSResponse)(nil),                                       // 36: eos.rpc.NSResponse
	(*NsStatRequest)(nil),                                    // 37: eos.rpc.NsStatRequest
	(*NsStatResponse)(nil),                                   // 38: eos.rpc.NsStatResponse
	nil,                                                      // 39: eos.rpc.FileMdProto.XattrsEntry
	nil,                                                      // 40: eos.rpc.ContainerMdProto.XattrsEntry
	nil,                                                      // 41: eos.rpc.MDSelection.XattrEntry
	(*NSRequest_MkdirRequest)(nil),                           // 42: eos.rpc.NSRequest.MkdirRequest
	(*NSRequest_RmdirRequest)(nil),                           // 43: eos.rpc.NSRequest.RmdirRequest
	(*NSRequest_TouchRequest)(nil),                           // 44: eos.rpc.NSRequest.TouchRequest
	(*NSRequest_UnlinkRequest)(nil),                          // 45: eos.rpc.NSRequest.UnlinkRequest
	(*NSRequest_RmRequest)(nil),                              // 46: eos.rpc.NSRequest.RmRequest
	(*NSRequest_RenameRequest)(nil),                          // 47: eos.rpc.NSRequest.RenameRequest
	(*NSRequest_SymlinkRequest)(nil),                         // 48: eos.rpc.NSRequest.SymlinkRequest
	(*NSRequest_VersionRequest)(nil),                         // 49: eos.rpc.NSRequest.VersionRequest
	(*NSRequest_RecycleRequest)(nil),                         // 50: eos.rpc.NSRequest.RecycleRequest
	(*NSRequest_SetXAttrRequest)(nil),                        // 51: eos.rpc.NSRequest.SetXAttrRequest
	(*NSRequest_ChownRequest)(nil),                           // 52: eos.rpc.NSRequest.ChownRequest
	(*NSRequest_ChmodRequest)(nil),                           // 53: eos.rpc.NSRequest.ChmodRequest
	(*NSRequest_AclRequest)(nil),                             // 54: eos.rpc.NSRequest.AclRequest
	(*NSRequest_TokenRequest)(nil),                           // 55: eos.rpc.NSRequest.TokenRequest
	(*NSRequest_QuotaRequest)(nil),                           // 56: eos.rpc.NSRequest.QuotaRequest
	(*NSRequest_ShareRequest)(nil),                           // 57: eos.rpc.NSRequest.ShareRequest
	(*NSRequest_RecycleRequest_RestoreFlags)(nil),            // 58: eos.rpc.NSRequest.RecycleRequest.RestoreFlags
	(*NSRequest_RecycleRequest_PurgeDate)(nil),               // 59: eos.rpc.NSRequest.RecycleRequest.PurgeDate
	...
	(*NSResponse_VersionResponse_VersionInfo)(nil), // 72: eos.rpc.NSResponse.VersionResponse.VersionInfo
	(*NSResponse_RecycleResponse_RecycleInfo)(nil), // 73: eos.rpc.NSResponse.RecycleResponse.RecycleInfo
	(*RecycleProto)(nil),                           // 74: eos.console.RecycleProto
	(*TrafficShapingRateRequest)(nil),              // 75: eos.traffic_shaping.TrafficShapingRateRequest
	(*TrafficShapingRateResponse)(nil),             // 76: eos.traffic_shaping.TrafficShapingRateResponse
}
var file_Rpc_proto_depIdxs = []int32{
	22,  // 0: eos.rpc.ContainerInsertRequest.container:type_name -> eos.rpc.ContainerMdProto
	21,  // 1: eos.rpc.FileInsertRequest.files:type_name -> eos.rpc.FileMdProto
	19,  // 2: eos.rpc.FileMdProto.ctime:type_name -> eos.rpc.Time
	19,  // 3: eos.rpc.FileMdProto.mtime:type_name -> eos.rpc.Time
	20,  // 4: eos.rpc.FileMdProto.checksum:type_name -> eos.rpc.Checksum
	39,  // 5: eos.rpc.FileMdProto.xattrs:type_name -> eos.rpc.FileMdProto.XattrsEntry
	20,  // 6: eos.rpc.FileMdProto.checksums:type_name -> eos.rpc.Checksum
	19,  // 7: eos.rpc.ContainerMdProto.ctime:type_name -> eos.rpc.Time
	19,  // 8: eos.rpc.ContainerMdProto.mtime:type_name -> eos.rpc.Time
	19,  // 9: eos.rpc.ContainerMdProto.stime:type_name -> eos.rpc.Time
	40,  // 10: eos.rpc.ContainerMdProto.xattrs:type_name -> eos.rpc.ContainerMdProto.XattrsEntry
	1,   // 11: eos.rpc.QuotaProto.type:type_name -> eos.rpc.QUOTATYPE
	0,   // 12: eos.rpc.MDId.type:type_name -> eos.rpc.TYPE
	26,  // 13: eos.rpc.MDSelection.ctime:type_name -> eos.rpc.Limit
	26,  // 14: eos.rpc.MDSelection.mtime:type_name -> eos.rpc.Limit
	26,  // 15: eos.rpc.MDSelection.stime:type_name -> eos.rpc.Limit
	26,  // 16: eos.rpc.MDSelection.size:type_name -> eos.rpc.Limit
	26,  // 17: eos.rpc.MDSelection.treesize:type_name -> eos.rpc.Limit
	26,  // 18: eos.rpc.MDSelection.children:type_name -> eos.rpc.Limit
	26,  // 19: eos.rpc.MDSelection.locations:type_name -> eos.rpc.Limit
	26,  // 20: eos.rpc.MDSelection.unlinked_locations:type_name -> eos.rpc.Limit
	20,  // 21: eos.rpc.MDSelection.checksum:type_name -> eos.rpc.Checksum
	41,  // 22: eos.rpc.MDSelection.xattr:type_name -> eos.rpc.MDSelection.XattrEntry
	0,   // 23: eos.rpc.MDRequest.type:type_name -> eos.rpc.TYPE
	25,  // 24: eos.rpc.MDRequest.id:type_name -> eos.rpc.MDId
	24,  // 25: eos.rpc.MDRequest.role:type_name -> eos.rpc.RoleId
	27,  // 26: eos.rpc.MDRequest.selection:type_name -> eos.rpc.MDSelection
	0,   // 27: eos.rpc.MDResponse.type:type_name -> eos.rpc.TYPE
	21,  // 28: eos.rpc.MDResponse.fmd:type_name -> eos.rpc.FileMdProto
	22,  // 29: eos.rpc.MDResponse.cmd:type_name -> eos.rpc.ContainerMdProto
	0,   // 30: eos.rpc.MDNotification.type:type_name -> eos.rpc.TYPE
	21,  // 31: eos.rpc.MDNotification.fmd:type_name -> eos.rpc.FileMdProto
	22,  // 32: eos.rpc.MDNotification.cmd:type_name -> eos.rpc.ContainerMdProto
	24,  // 33: eos.rpc.MDNotification.role:type_name -> eos.rpc.RoleId
	0,   // 34: eos.rpc.FindRequest.type:type_name -> eos.rpc.TYPE
	25,  // 35: eos.rpc.FindRequest.id:type_name -> eos.rpc.MDId
	24,  // 36: eos.rpc.FindRequest.role:type_name -> eos.rpc.RoleId
	27,  // 37: eos.rpc.FindRequest.selection:type_name -> eos.rpc.MDSelection
	32,  // 38: eos.rpc.ShareProto.origins:type_name -> eos.rpc.ShareAuth
	33,  // 39: eos.rpc.ShareToken.token:type_name -> eos.rpc.ShareProto
	24,  // 40: eos.rpc.NSRequest.role:type_name -> eos.rpc.RoleId
	42,  // 41: eos.rpc.NSRequest.mkdir:type_name -> eos.rpc.NSRequest.MkdirRequest
	43,  // 42: eos.rpc.NSRequest.rmdir:type_name -> eos.rpc.NSRequest.RmdirRequest
	44,  // 43: eos.rpc.NSRequest.touch:type_name -> eos.rpc.NSRequest.TouchRequest
	45,  // 44: eos.rpc.NSRequest.unlink:type_name -> eos.rpc.NSRequest.UnlinkRequest
	46,  // 45: eos.rpc.NSRequest.rm:type_name -> eos.rpc.NSRequest.RmRequest
	47,  // 46: eos.rpc.NSRequest.rename:type_name -> eos.rpc.NSRequest.RenameRequest
	48,  // 47: eos.rpc.NSRequest.symlink:type_name -> eos.rpc.NSRequest.SymlinkRequest
	49,  // 48: eos.rpc.NSRequest.version:type_name -> eos.rpc.NSRequest.VersionRequest
	50,  // 49: eos.rpc.NSRequest.old_recycle:type_name -> eos.rpc.NSRequest.RecycleRequest
	51,  // 50: eos.rpc.NSRequest.xattr:type_name -> eos.rpc.NSRequest.SetXAttrRequest
	52,  // 51: eos.rpc.NSRequest.chown:type_name -> eos.rpc.NSRequest.ChownRequest
	53,  // 52: eos.rpc.NSRequest.chmod:type_name -> eos.rpc.NSRequest.ChmodRequest
	54,  // 53: eos.rpc.NSRequest.acl:type_name -> eos.rpc.NSRequest.AclRequest
	55,  // 54: eos.rpc.NSRequest.token:type_name -> eos.rpc.NSRequest.TokenRequest
	56,  // 55: eos.rpc.NSRequest.quota:type_name -> eos.rpc.NSRequest.QuotaRequest
	57,  // 56: eos.rpc.NSRequest.share:type_name -> eos.rpc.NSRequest.ShareRequest
	74,  // 57: eos.rpc.NSRequest.recycle:type_name -> eos.console.RecycleProto
	64,  // 58: eos.rpc.NSResponse.error:type_name -> eos.rpc.NSResponse.ErrorResponse
	65,  // 59: eos.rpc.NSResponse.version:type_name -> eos.rpc.NSResponse.VersionResponse
	66,  // 60: eos.rpc.NSResponse.recycle:type_name -> eos.rpc.NSResponse.RecycleResponse
	67,  // 61: eos.rpc.NSResponse.acl:type_name -> eos.rpc.NSResponse.AclResponse
	68,  // 62: eos.rpc.NSResponse.quota:type_name -> eos.rpc.NSResponse.QuotaResponse
	71,  // 63: eos.rpc.NSResponse.share:type_name -> eos.rpc.NSResponse.ShareResponse
	25,  // 64: eos.rpc.NSRequest.MkdirRequest.id:type_name -> eos.rpc.MDId
	25,  // 65: eos.rpc.NSRequest.RmdirRequest.id:type_name -> eos.rpc.MDId
	25,  // 66: eos.rpc.NSRequest.TouchRequest.id:type_name -> eos.rpc.MDId
	25,  // 67: eos.rpc.NSRequest.UnlinkRequest.id:type_name -> eos.rpc.MDId
	25,  // 68: eos.rpc.NSRequest.RmRequest.id:type_name -> eos.rpc.MDId
	25,  // 69: eos.rpc.NSRequest.RenameRequest.id:type_name -> eos.rpc.MDId
	25,  // 70: eos.rpc.NSRequest.SymlinkRequest.id:type_name -> eos.rpc.MDId
	25,  // 71: eos.rpc.NSRequest.VersionRequest.id:type_name -> eos.rpc.MDId
	4,   // 72: eos.rpc.NSRequest.VersionRequest.cmd:type_name -> eos.rpc.NSRequest.VersionRequest.VERSION_CMD
	6,   // 73: eos.rpc.NSRequest.RecycleRequest.cmd:type_name -> eos.rpc.NSRequest.RecycleRequest.RECYCLE_CMD
	58,  // 74: eos.rpc.NSRequest.RecycleRequest.restoreflag:type_name -> eos.rpc.NSRequest.RecycleRequest.RestoreFlags
	59,  // 75: eos.rpc.NSRequest.RecycleRequest.purgedate:type_name -> eos.rpc.NSRequest.RecycleRequest.PurgeDate
	60,  // 76: eos.rpc.NSRequest.RecycleRequest.listflag:type_name -> eos.rpc.NSRequest.RecycleRequest.ListFlags
	25,  // 77: eos.rpc.NSRequest.SetXAttrRequest.id:type_name -> eos.rpc.MDId
	61,  // 78: eos.rpc.NSRequest.SetXAttrRequest.xattrs:type_name -> eos.rpc.NSRequest.SetXAttrRequest.XattrsEntry
	25,  // 79: eos.rpc.NSRequest.ChownRequest.id:type_name -> eos.rpc.MDId
	24,  // 80: eos.rpc.NSRequest.ChownRequest.owner:type_name -> eos.rpc.RoleId
	25,  // 81: eos.rpc.NSRequest.ChmodRequest.id:type_name -> eos.rpc.MDId
	25,  // 82: eos.rpc.NSRequest.AclRequest.id:type_name -> eos.rpc.MDId
	7,   // 83: eos.rpc.NSRequest.AclRequest.cmd:type_name -> eos.rpc.NSRequest.AclRequest.ACL_COMMAND
	8,   // 84: eos.rpc.NSRequest.AclRequest.type:type_name -> eos.rpc.NSRequest.AclRequest.ACL_TYPE
	34,  // 85: eos.rpc.NSRequest.TokenRequest.token:type_name -> eos.rpc.ShareToken
	24,  // 86: eos.rpc.NSRequest.QuotaRequest.id:type_name -> eos.rpc.RoleId
	2,   // 87: eos.rpc.NSRequest.QuotaRequest.op:type_name -> eos.rpc.QUOTAOP
	3,   // 88: eos.rpc.NSRequest.QuotaRequest.entry:type_name -> eos.rpc.QUOTAENTRY
	62,  // 89: eos.rpc.NSRequest.ShareRequest.ls:type_name -> eos.rpc.NSRequest.ShareRequest.LsShare
	63,  // 90: eos.rpc.NSRequest.ShareRequest.op:type_name -> eos.rpc.NSRequest.ShareRequest.OperateShare
	5,   // 91: eos.rpc.NSRequest.RecycleRequest.ListFlags.display:type_name -> eos.rpc.NSRequest.RecycleRequest.DisplayType
	9,   // 92: eos.rpc.NSRequest.ShareRequest.LsShare.outformat:type_name -> eos.rpc.NSRequest.ShareRequest.LsShare.OutFormat
	10,  // 93: eos.rpc.NSRequest.ShareRequest.OperateShare.op:type_name -> eos.rpc.NSRequest.ShareRequest.OperateShare.Op
	72,  // 94: eos.rpc.NSResponse.VersionResponse.versions:type_name -> eos.rpc.NSResponse.VersionResponse.VersionInfo
	73,  // 95: eos.rpc.NSResponse.RecycleResponse.recycles:type_name -> eos.rpc.NSResponse.RecycleResponse.RecycleInfo
	23,  // 96: eos.rpc.NSResponse.QuotaResponse.quotanode:type_name -> eos.rpc.QuotaProto
	69,  // 97: eos.rpc.NSResponse.ShareResponse.shares:type_name -> eos.rpc.NSResponse.ShareInfo
	70,  // 98: eos.rpc.NSResponse.ShareResponse.access:type_name -> eos.rpc.NSResponse.ShareAccess
	25,  // 99: eos.rpc.NSResponse.VersionResponse.VersionInfo.id:type_name -> eos.rpc.MDId
	19,  // 100: eos.rpc.NSResponse.VersionResponse.VersionInfo.mtime:type_name -> eos.rpc.Time
	25,  // 101: eos.rpc.NSResponse.RecycleResponse.RecycleInfo.id:type_name -> eos.rpc.MDId
	24,  // 102: eos.rpc.NSResponse.RecycleResponse.RecycleInfo.owner:type_name -> eos.rpc.RoleId
	19,  // 103: eos.rpc.NSResponse.RecycleResponse.RecycleInfo.dtime:type_name -> eos.rpc.Time
	11,  // 104: eos.rpc.NSResponse.RecycleResponse.RecycleInfo.type:type_name -> eos.rpc.NSResponse.RecycleResponse.RecycleInfo.DELETIONTYPE
	12,  // 105: eos.rpc.Eos.Ping:input_type -> eos.rpc.PingRequest
	14,  // 106: eos.rpc.Eos.Notify:input_type -> eos.rpc.NotificationRequest
	28,  // 107: eos.rpc.Eos.MD:input_type -> eos.rpc.MDRequest
	14,  // 108: eos.rpc.Eos.Notification:input_type -> eos.rpc.NotificationRequest
	31,  // 109: eos.rpc.Eos.Find:input_type -> eos.rpc.FindRequest
	37,  // 110: eos.rpc.Eos.NsStat:input_type -> eos.rpc.NsStatRequest
	16,  // 111: eos.rpc.Eos.ContainerInsert:input_type -> eos.rpc.ContainerInsertRequest
	17,  // 112: eos.rpc.Eos.FileInsert:input_type -> eos.rpc.FileInsertRequest
	35,  // 113: eos.rpc.Eos.Exec:input_type -> eos.rpc.NSRequest
	75,  // 114: eos.rpc.Eos.TrafficShapingRate:input_type -> eos.traffic_shaping.TrafficShapingRateRequest
	13,  // 115: eos.rpc.Eos.Ping:output_type -> eos.rpc.PingReply
	15,  // 116: eos.rpc.Eos.Notify:output_type -> eos.rpc.NotificationResponse
	29,  // 117: eos.rpc.Eos.MD:output_type -> eos.rpc.MDResponse
	15,  // 118: eos.rpc.Eos.Notification:output_type -> eos.rpc.NotificationResponse
	29,  // 119: eos.rpc.Eos.Find:output_type -> eos.rpc.MDResponse
	38,  // 120: eos.rpc.Eos.NsStat:output_type -> eos.rpc.NsStatResponse
	18,  // 121: eos.rpc.Eos.ContainerInsert:output_type -> eos.rpc.InsertReply
	18,  // 122: eos.rpc.Eos.FileInsert:output_type -> eos.rpc.InsertReply
	36,  // 123: eos.rpc.Eos.Exec:output_type -> eos.rpc.NSResponse
	76,  // 124: eos.rpc.Eos.TrafficShapingRate:output_type -> eos.traffic_shaping.TrafficShapingRateResponse
	115, // [115:125] is the sub-list for method output_type
	105, // [105:115] is the sub-list for method input_type
...
func file_Rpc_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_Rpc_proto_msgTypes[48].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*NSRequest_RecycleRequest_ListFlags); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_Rpc_proto_msgTypes[23].OneofWrappers = []interface{}{
		(*NSRequest_Mkdir)(nil),
		(*NSRequest_Rmdir)(nil),
		(*NSRequest_Touch)(nil),
	...
	file_Rpc_proto_msgTypes[45].OneofWrappers = []interface{}{
